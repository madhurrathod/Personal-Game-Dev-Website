...
function Home(){
    return (<>
        ...
        <a href="https://www.youtube.com/@MadhurSensei/videos" target="_blank"><button>YouTube Channel</button></a>
        <a href="https://www.linkedin.com/in/madhur-rathod-8a5266220/" target="_blank"><button>LinkedIn</button></a>
